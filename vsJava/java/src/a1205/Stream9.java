...
public class Stream9 {
    public static void main(String[] args) {
        ...
        Member m1 = new Member("김바다", Member.Male, 30);
        Member m2 = new Member("안선재", Member.Female, 25);
        Member m3 = new Member("유하늘", Member.Male, 32);
        Member m4 = new Member("윤시현", Member.Male, 29); 
